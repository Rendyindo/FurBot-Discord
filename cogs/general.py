...
class General():
    ...
    async def weather(self, ctx, *args):
        ...
        embed.add_field(name="Current Weather", value="`{}`".format(e.condition().text()), inline=True)
        ...
        embed.add_field(name="Wind Speed", value="`{}{}`".format(e.atmosphere()['humidity'], e.units()['speed']), inline=True)
